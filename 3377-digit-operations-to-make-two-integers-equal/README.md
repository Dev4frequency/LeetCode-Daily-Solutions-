<h2><a href="https://leetcode.com/problems/digit-operations-to-make-two-integers-equal/?envType=problem-list-v2&envId=number-theory">3377. Digit Operations to Make Two Integers Equal</a></h2><h3>Medium</h3><hr><p>You are given two integers <code>n</code> and <code>m</code> that consist of the <strong>same</strong> number of digits.</p>
